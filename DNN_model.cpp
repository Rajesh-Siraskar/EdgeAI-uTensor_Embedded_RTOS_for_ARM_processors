...
{    
    ctx.add(new BinaryTensor<float>({6,60}, inline_Variable_0), 
            "Variable:0", 
            2);
}
{    
...
}
{
    ...
    ctx.push(new QntMatMulOp<uint8_t, uint8_t, int>(), 
             { "MatMul_eightbit/x__port__0/quantize:0", "MatMul_eightbit/x__port__0/quantize:1", "MatMul_eightbit/x__port__0/quantize:2", "MatMul_eightbit/Variable__port__0/quantize:0", "MatMul_eightbit/Variable__port__0/quantize:1",  "MatMul_eightbit/Variable__port__0/quantize:2" },
...
{    
    ctx.add(new BinaryTensor<float>({60}, inline_Variable_1_0), 
            "Variable_1:0", 
            2);
}
{    
...
{    
    ctx.add(new BinaryTensor<uint8_t>({60,60}, inline_Variable_2_quantized_const_0), 
...
{    
    ctx.add(new BinaryTensor<float>({60}, inline_Variable_3_0), 
            "Variable_3:0", 
            2);
}
{    
...
{    
    ctx.add(new BinaryTensor<float>({60,6}, inline_Variable_4_0), 
            "Variable_4:0", 
            2);
}
{    
